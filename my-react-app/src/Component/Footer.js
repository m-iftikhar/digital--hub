...
const Footer = () => {
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-white'>
      <div className="flex flex-col"> {/* Ensure proper flex display */}
        <h1 className='text-3xl font-bold text-black'>Digital Hub.</h1>
        <p className='py-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Id odit ullam iste repellat consequatur libero reiciendis, blanditiis accusantium.</p>
        <div className='flex justify-between w-full my-6'> {/* Ensure icons are within flex container */}
